...
const Header = () => {
    ...
    return (
        <Navbar className="navbar" bg="" expand="lg" sticky="top">
            <Container className="">
                <Link to="/home" className="fw-bolder fs-2 me-5 text-decoration-none text-white"> <img src="https://cdn-icons-png.flaticon.com/128/2790/2790191.png" className="img-fluid brand-logo" alt="" /></Link>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    {
                        user.email && <span className="user-name me-2 fs-5" style={{ color: "white" }}>{user.displayName ? user.displayName : ''}</span>
                    }
